  ...
  return (
    <div className="container mx-auto text-gray p-4">
      <Banner
        title="IHRC Contact"
        imageUrl={
          "https://clinecthealthcare.com/wp-content/uploads/2021/05/Contact-Us.png"
        }
      />
      <div className="flex p-2">
        <div className="w-1/2">
          ...
          <p className="text-gray-700 mb-4">
            ...
            assistance, or want to provide feedback, please feel free to reach
            out to us. Our team is here to help.
          </p>
          <h2 className="text-2xl font-semibold mb-2">Contact Information</h2>
          <p className="text-gray-700 mb-4">
            <strong>Address:</strong> eHealth, Business Incubation Center,
            Health Services Academy, Prime Ministers National Health Complex,
