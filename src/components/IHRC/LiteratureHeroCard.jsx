...
const LiteratureHeroCard = ({ bgImage, heading }) => {
  return (
    <div>
      ...
      <div className=" overflow-hidden p-6 text-gray bg-graylight">
        <h2 className="text-[1rem] md:text-[1.5rem] font-bold mb-4">
          {heading}
        </h2>
      </div>
    </div>
...
export default LiteratureHeroCard;
