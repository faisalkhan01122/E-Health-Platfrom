  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="p-2">
        ...
        <p className="text-gray-700 mb-4">Health Services Academy,</p>
        <p className="text-gray-700 mb-4">
          Prime Ministers National Health Complex,
        </p>
        <p className="text-gray-700 mb-4">NIH Park Road, Chak Shahzad,</p>
        <p className="text-gray-700 mb-4">Islamabad.</p>
      </div>
    </div>
  );
};
