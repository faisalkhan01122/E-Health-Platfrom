...
const pharmacies = [
  {
    title: 'City Pharmacy',
    image: 'https://thumbs.dreamstime.com/b/pharmacy-building-isolated-white-background-d-illustration-150691554.jpg',
    description: 'Your trusted pharmacy for all your health needs.',
    bgColor: 'bg-blue-100',
  },
  {
    title: 'HealthPlus Pharmacy',
    image: 'https://media.istockphoto.com/id/1223842708/photo/pharmacy-store-or-drugstore-exterior-design.jpg?s=612x612&w=0&k=20&c=UCkyI4toMcOD9AFofXValHqg0grRRPp6ztV8ROt-_pw=',
    description: 'Providing quality medicines and health products.',
    bgColor: 'bg-green-100',
  },
  {
    title: 'Wellness Pharmacy',
    image: 'https://media.istockphoto.com/id/1449832348/vector/rx-pharmaceutical-capsule-medicine-logo-vector-drug-choice-drugstore-vector-logo-template.jpg?s=612x612&w=0&k=20&c=jk6Mc_KPIfNTyc2gdbnCaPD8HzyyOvT64op2AEEbMTI=',
    description: 'Your partner in health and wellness.',
    bgColor: 'bg-yellow-100',
  },
  {
    title: 'Care Pharmacy',
    image: 'https://static.vecteezy.com/system/resources/previews/008/923/894/non_2x/pharmacy-building-isolated-on-white-background-vector.jpg',
